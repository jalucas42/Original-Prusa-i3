...
module x_end_idler_holes(){
    //x_end_holes();
    translate([0,3.5,0]){
        translate(v=[0,-23,x_end_base_height/2]) rotate(a=[0,-90,0]) cylinder(h = 80, r=1.8, $fn=30);
        translate(v=[-t8nut_id/2,-23,x_end_base_height/2]) rotate(a=[0,-90,0]) cylinder(h = 3, r=3.1, $fn=30);
        translate(v=[-t8nut_id/2-x_end_base_depth-1.5+2.5,-23,x_end_base_height/2]) rotate(a=[0,-90,0]) cylinder(h = 80, d=6.4, $fn=6);
...
module x_end_idler_base(){
    ...
    translate(v=[-x_to_z_offset+x_end_belt_hole_width/2,-23+3.5,x_end_base_height/2]) rotate(a=[0,-90,0]) cylinder(h = 0.80, d1=x_idler_bearing_id+4, d2=x_idler_bearing_id+2, $fn=12);
    translate(v=[-x_to_z_offset-x_end_belt_hole_width/2,-23+3.5,x_end_base_height/2]) rotate(a=[0,+90,0]) cylinder(h = 0.80, d1=x_idler_bearing_id+4, d2=x_idler_bearing_id+2, $fn=12);
}
